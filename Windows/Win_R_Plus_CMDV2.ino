...
//Keyboard.print("Hello World");
  ...
  delay(1000);
  //affichage processus en cours
  Keyboard.print(fr2en("gps")+"\n");
  
  delay(1000);
  
  //affichage information machine
  Keyboard.print(fr2en("gin")+"\n");
  delay(1000);
  //affichage historique commande
  Keyboard.print(fr2en("Get-History")+"\n");

   delay(1000);
  //supprime historique de commande
  Keyboard.print(fr2en("clear-history")+"\n");
  digitalWrite(ledPin, LOW);
  //count = count +1;
  delay(3000);
